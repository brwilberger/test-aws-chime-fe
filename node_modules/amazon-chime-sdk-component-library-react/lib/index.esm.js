...
var MeetingManager = /** @class */ (function () {
    function MeetingManager(config) {
        ...
        this.selectAudioInputDevice = function (deviceId) { return __awaiter(_this, void 0, void 0, function () {
            var receivedDevice, e_1, e_2, error_1;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        e_1 = _c.sent();
                        console.error('Failed to choose audio input device.', e_1);
                        return [3 /*break*/, 4];
                    case 4:
                        this.selectedAudioInputDevice = null;
                        return [3 /*break*/, 9];
                    ...
                    case 7:
                        e_2 = _c.sent();
                        console.error('Failed to choose audio output device.', e_2);
                        return [3 /*break*/, 8];
                    case 8:
    ...
    MeetingManager.prototype.setupDeviceLabelTrigger = function () {
        ...
        var callback = function () { return __awaiter(_this, void 0, void 0, function () {
            var devices, hasVideoInput, stream, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        devices = _a.sent();
                        hasVideoInput = devices.some(function (value) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        e_5 = _c.sent();
                        console.error("Error in selecting audio input device - " + e_5);
                        return [3 /*break*/, 5];
                    case 5:
                        this.publishSelectedAudioInputDevice();
                        _c.label = 6;
                    ...
                    case 9:
                        e_6 = _c.sent();
                        console.error('Failed to choose audio output device.', e_6);
                        return [3 /*break*/, 10];
                    case 10:
                        this.publishSelectedAudioOutputDevice();
                        _c.label = 11;
